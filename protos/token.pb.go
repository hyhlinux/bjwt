...
func (*GenToekenRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*GenTokenResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*CheckToekenRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func init() { proto.RegisterFile("protos/token.proto", fileDescriptor0) }
